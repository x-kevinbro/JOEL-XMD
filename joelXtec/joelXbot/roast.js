...
const roastList = [
  ...
  "You're like a cloud of toxic gas — everyone avoids you.",
  ...
  "You're like an online exam — stressful and full of errors.",
  ...
  "You're the lag that ruins the game.",
  ...
  "You're the kind of error that crashes systems.",
  ...
  "You're the reason we need a debug mode for life.",
  "You're like a leaked password — exposed and irrelevant.",
  "You’re the error 404 of personalities.",
  "You're more confusing than a JavaScript callback.",
  "You're like an incognito tab — here, but useless.",
  ...
  "You're the reason we need airplane mode in life.",
  ...
  "You're like CTRL + ALT + DEL — only useful when something's wrong.",
  "You're like a screenshot of a blank screen — useless.",
  ...
  "You're the cooldown period in life’s game — slowing everyone down.",
  "You're the typo in every perfect sentence.",
  ...
  "You're more extra than RAM in a toaster.",
  "You're the wrong answer on a multiple-choice test.",
  "You're like an old meme — out of touch and embarrassing.",
  "You're the static on the radio of life.",
  "You're the crash log of my peace.",
  "You're the settings nobody customizes.",
  ...
  "You're the 'skip ad' button that doesn't work.",
  ...
  "You're the error message no one understands.",
...
const roastCmd = async (m, sock) => {
  ...
  if (cmd === 'roast') {
    ...
    if (m.key.remoteJid.endsWith('@g.us') && numbersThatCantBeRoasted.includes(senderNumber)) {
